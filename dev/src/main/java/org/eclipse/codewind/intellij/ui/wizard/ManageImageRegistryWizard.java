...
public class ManageImageRegistryWizard  extends AbstractWizardEx {

    public ManageImageRegistryWizard(String title, @Nullable Project project, List<? extends AbstractWizardStepEx> steps) {
...
//        currentStepObject.doOKAction();
        ManageImageRegistryStep manageImageRegistryStep = (ManageImageRegistryStep)getCurrentStepObject();
        manageImageRegistryStep.doOKAction();
